      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 bottom-0 w-[85%] max-w-sm bg-[#0A192F] z-[70] lg:hidden border-r border-[#233554] flex flex-col"
          >
                        ...
                        <AnimatePresence>
                          {activeSub === menu.id && (
                            <motion.div
                              ...
                              className="overflow-hidden ml-4 border-l border-[#233554]"
                            >
