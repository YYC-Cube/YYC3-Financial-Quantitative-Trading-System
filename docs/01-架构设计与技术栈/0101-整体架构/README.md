---
file: README.md
description: 01-架构设计与技术栈 / 0101-整体架构 目录文档索引
...
category: 01-架构设计与技术栈 / 0101-整体架构
project: YYC³-QATS
---
...
| 序号 | 文档名称 | 描述 | 标签 |
|------|----------|------|------|
| 1 | [0101-整体架构-001-系统架构总览图.md](0101-整体架构-001-系统架构总览图.md) | Vite+React全栈架构：Vite构建 → React组件库 → AI Family服务层 → BigModel SDK → 静态部署 | [架构设计],[Vite],[全栈架构] |
| 2 | [0101-整体架构-002-技术选型论证报告.md](0101-整体架构-002-技术选型论证报告.md) | 技术选型依据：Vite vs Webpack / React vs Vue / Tailwind vs CSS-in-JS / pnpm vs npm | [架构设计],[技术选型],[对比分析] |
| 3 | [0101-整体架构-003-目录结构规范.md](0101-整体架构-003-目录结构规范.md) | 项目目录约定：src/app/(页面) → src/app/components/(组件) → src/app/services/(服务) → src/app/utils/(工具) | [架构设计],[目录约定],[项目结构] |
| 4 | [0101-整体架构-004-AI Family架构设计.md](0101-整体架构-004-AI Family架构设计.md) | 8大AI成员矩阵：天枢(编排) + 千行(NLU) + 万物(分析) + 先知(预测) + 伯乐(推荐) + 守护(安全) + 宗师(质量) + 灵韵(创意) | [架构设计],[AI Family],[智能体] |
| 5 | [0101-整体架构-005-Vite配置详解.md](0101-整体架构-005-Vite配置详解.md) | Vite构建配置：React插件、路径别名、环境变量、构建优化、依赖预构建 | [架构设计],[Vite配置],[构建优化] |
