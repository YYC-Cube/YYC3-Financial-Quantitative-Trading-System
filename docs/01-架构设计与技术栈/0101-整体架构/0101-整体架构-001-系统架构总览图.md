---
file: 0101-整体架构-001-系统架构总览图.md
description: Vite+React全栈架构：Vite构建 → React组件库 → AI Family服务层 → BigModel SDK → 静态部署
...
status: published
tags: 架构设计,Vite,全栈架构
category: 0101 整体架构 001 系统架构总览图
language: zh-CN
...
Vite+React全栈架构：Vite构建 → React组件库 → AI Family服务层 → BigModel SDK → 静态部署

---

## 概述

本节描述：Vite+React全栈架构：Vite构建 → React组件库 → AI Family服务层 → BigModel SDK → 静态部署
