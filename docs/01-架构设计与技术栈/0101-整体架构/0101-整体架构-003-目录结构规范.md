---
file: 0101-整体架构-003-目录结构规范.md
description: 项目目录约定：src/app/(页面) → src/app/components/(组件) → src/app/services/(服务) → src/app/utils/(工具)
...
项目目录约定：src/app/(页面) → src/app/components/(组件) → src/app/services/(服务) → src/app/utils/(工具)

---

## 概述

本节描述：项目目录约定：src/app/(页面) → src/app/components/(组件) → src/app/services/(服务) → src/app/utils/(工具)
