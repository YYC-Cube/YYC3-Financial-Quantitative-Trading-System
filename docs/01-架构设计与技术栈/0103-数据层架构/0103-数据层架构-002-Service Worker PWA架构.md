---
file: 0103-数据层架构-002-Service Worker PWA架构.md
description: PWA支持：离线访问、资源缓存策略、后台同步、推送通知
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: 数据层,PWA,Service Worker
category: 0103 数据层架构 002 Service Worker PWA架构
language: zh-CN
...
# 0103 数据层架构 002 Service Worker PWA架构
...
PWA支持：离线访问、资源缓存策略、后台同步、推送通知

---

## 概述

本节描述：PWA支持：离线访问、资源缓存策略、后台同步、推送通知
