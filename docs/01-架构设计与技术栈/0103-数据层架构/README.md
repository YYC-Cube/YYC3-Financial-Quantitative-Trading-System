---
file: README.md
description: 01-架构设计与技术栈 / 0103-数据层架构 目录文档索引
...
category: 01-架构设计与技术栈 / 0103-数据层架构
project: YYC³-QATS
---
...
| 序号 | 文档名称 | 描述 | 标签 |
|------|----------|------|------|
| 1 | [0103-数据层架构-001-IndexedDB数据管理.md](0103-数据层架构-001-IndexedDB数据管理.md) | IndexedDB(idb 8.0.3)本地存储方案：交易数据缓存、用户偏好持久化、离线数据支持 | [数据层],[IndexedDB],[本地存储] |
| 2 | [0103-数据层架构-002-Service Worker PWA架构.md](0103-数据层架构-002-Service Worker PWA架构.md) | PWA支持：离线访问、资源缓存策略、后台同步、推送通知 | [数据层],[PWA],[Service Worker] |
