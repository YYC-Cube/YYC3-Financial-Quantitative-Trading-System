---
file: 0102-前端架构-001-React组件体系设计.md
description: 组件分层：页面组件(Page) → 业务组件(Business) → 通用组件(Common) → 图标组件(SafeIcons 131个纯函数SVG)
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: 前端架构,React,组件设计
category: 0102 前端架构 001 React组件体系设计
language: zh-CN
...
组件分层：页面组件(Page) → 业务组件(Business) → 通用组件(Common) → 图标组件(SafeIcons 131个纯函数SVG)

---

## 概述

本节描述：组件分层：页面组件(Page) → 业务组件(Business) → 通用组件(Common) → 图标组件(SafeIcons 131个纯函数SVG)
