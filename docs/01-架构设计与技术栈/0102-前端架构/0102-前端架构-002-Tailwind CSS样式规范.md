---
file: 0102-前端架构-002-Tailwind CSS样式规范.md
description: Tailwind CSS原子化样式约定：自定义主题、响应式设计、暗色模式、组件样式封装
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: 前端架构,Tailwind CSS,样式规范
category: 0102 前端架构 002 Tailwind CSS样式规范
language: zh-CN
...
# 0102 前端架构 002 Tailwind CSS样式规范
...
Tailwind CSS原子化样式约定：自定义主题、响应式设计、暗色模式、组件样式封装

---

## 概述

本节描述：Tailwind CSS原子化样式约定：自定义主题、响应式设计、暗色模式、组件样式封装
...
- 标签: [前端架构],[Tailwind CSS],[样式规范]
- 所属模块: 01-架构设计与技术栈 / 0102-前端架构
