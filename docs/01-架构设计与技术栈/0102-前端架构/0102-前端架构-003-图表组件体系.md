---
file: 0102-前端架构-003-图表组件体系.md
description: Recharts数据可视化 + lightweight-charts金融图表：K线图、分时图、深度图、技术指标图
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: 前端架构,Recharts,数据可视化
category: 0102 前端架构 003 图表组件体系
language: zh-CN
...
Recharts数据可视化 + lightweight-charts金融图表：K线图、分时图、深度图、技术指标图

---

## 概述

本节描述：Recharts数据可视化 + lightweight-charts金融图表：K线图、分时图、深度图、技术指标图
