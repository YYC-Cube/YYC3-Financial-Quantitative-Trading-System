---
file: README.md
description: 01-架构设计与技术栈 / 0102-前端架构 目录文档索引
...
category: 01-架构设计与技术栈 / 0102-前端架构
project: YYC³-QATS
---
...
| 序号 | 文档名称 | 描述 | 标签 |
|------|----------|------|------|
| 1 | [0102-前端架构-001-React组件体系设计.md](0102-前端架构-001-React组件体系设计.md) | 组件分层：页面组件(Page) → 业务组件(Business) → 通用组件(Common) → 图标组件(SafeIcons 131个纯函数SVG) | [前端架构],[React],[组件设计] |
| 2 | [0102-前端架构-002-Tailwind CSS样式规范.md](0102-前端架构-002-Tailwind CSS样式规范.md) | Tailwind CSS原子化样式约定：自定义主题、响应式设计、暗色模式、组件样式封装 | [前端架构],[Tailwind CSS],[样式规范] |
| 3 | [0102-前端架构-003-图表组件体系.md](0102-前端架构-003-图表组件体系.md) | Recharts数据可视化 + lightweight-charts金融图表：K线图、分时图、深度图、技术指标图 | [前端架构],[Recharts],[数据可视化] |
| 4 | [0102-前端架构-004-状态管理架构.md](0102-前端架构-004-状态管理架构.md) | React Hooks状态管理：自定义Hooks + Context + IndexedDB本地持久化 | [前端架构],[React Hooks],[状态管理] |
