---
file: 0501-构建部署-002-部署流程.md
description: 部署方案：pnpm build → 静态产物 → GitHub → 0379.world
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: 部署,GitHub,0379.world
category: 0501 构建部署 002 部署流程
language: zh-CN
...
部署方案：pnpm build → 静态产物 → GitHub → 0379.world

---

## 概述

本节描述：部署方案：pnpm build → 静态产物 → GitHub → 0379.world
...
- 标签: [部署],[GitHub],[0379.world]
- 所属模块: 05-部署与运维 / 0501-构建部署
