---
file: 0501-构建部署-001-Vite构建配置.md
description: Vite生产构建：代码分割、Tree Shaking、资源压缩、静态产物输出
...
status: published
tags: 部署,Vite,构建
category: 0501 构建部署 001 Vite构建配置
language: zh-CN
...
Vite生产构建：代码分割、Tree Shaking、资源压缩、静态产物输出

---

## 概述

本节描述：Vite生产构建：代码分割、Tree Shaking、资源压缩、静态产物输出
