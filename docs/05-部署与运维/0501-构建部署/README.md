---
file: README.md
description: 05-部署与运维 / 0501-构建部署 目录文档索引
...
| 序号 | 文档名称 | 描述 | 标签 |
|------|----------|------|------|
| 1 | [0501-构建部署-001-Vite构建配置.md](0501-构建部署-001-Vite构建配置.md) | Vite生产构建：代码分割、Tree Shaking、资源压缩、静态产物输出 | [部署],[Vite],[构建] |
| 2 | [0501-构建部署-002-部署流程.md](0501-构建部署-002-部署流程.md) | 部署方案：pnpm build → 静态产物 → GitHub → 0379.world | [部署],[GitHub],[0379.world] |
