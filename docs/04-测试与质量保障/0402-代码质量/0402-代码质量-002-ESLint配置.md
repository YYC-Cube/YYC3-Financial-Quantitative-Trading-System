---
file: 0402-代码质量-002-ESLint配置.md
description: eslint.config.js：生产/测试双层规则、TypeScript规则、Import排序
...
status: published
tags: 代码质量,ESLint,规范
category: 0402 代码质量 002 ESLint配置
language: zh-CN
...
eslint.config.js：生产/测试双层规则、TypeScript规则、Import排序

---

## 概述

本节描述：eslint.config.js：生产/测试双层规则、TypeScript规则、Import排序
