---
file: 0401-测试架构-001-测试架构设计.md
description: 测试分层：单元测试(Vitest) → 集成测试 → 端到端测试，7个测试文件228用例
...
测试分层：单元测试(Vitest) → 集成测试 → 端到端测试，7个测试文件228用例

---

## 概述

本节描述：测试分层：单元测试(Vitest) → 集成测试 → 端到端测试，7个测试文件228用例
