---
file: README.md
description: 04-测试与质量保障 / 0401-测试架构 目录文档索引
...
| 序号 | 文档名称 | 描述 | 标签 |
|------|----------|------|------|
| 1 | [0401-测试架构-001-测试架构设计.md](0401-测试架构-001-测试架构设计.md) | 测试分层：单元测试(Vitest) → 集成测试 → 端到端测试，7个测试文件228用例 | [测试],[Vitest],[架构] |
| 2 | [0401-测试架构-002-AI Family测试套件.md](0401-测试架构-002-AI Family测试套件.md) | 228个测试用例覆盖：编排器45 + NLU51 + 集成17 + 分析34 + 预测23 + SDK9 + 成员49 | [测试],[AI Family],[228用例] |
