---
file: README.md
description: 03-八大业务模块 / 0301-市场数据 目录文档索引
...
| 序号 | 文档名称 | 描述 | 标签 |
|------|----------|------|------|
| 1 | [0301-市场数据-001-实时行情模块.md](0301-市场数据-001-实时行情模块.md) | 实时行情展示：多交易所数据源(Binance/CoinGecko等)、WebSocket推送、深度图 | [业务模块],[行情],[实时数据] |
| 2 | [0301-市场数据-002-历史数据分析.md](0301-市场数据-002-历史数据分析.md) | 历史K线数据、技术指标计算、图表可视化(Recharts + lightweight-charts) | [业务模块],[历史数据],[图表] |
