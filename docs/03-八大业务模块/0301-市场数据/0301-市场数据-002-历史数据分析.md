---
file: 0301-市场数据-002-历史数据分析.md
description: 历史K线数据、技术指标计算、图表可视化(Recharts + lightweight-charts)
...
历史K线数据、技术指标计算、图表可视化(Recharts + lightweight-charts)

---

## 概述

本节描述：历史K线数据、技术指标计算、图表可视化(Recharts + lightweight-charts)
