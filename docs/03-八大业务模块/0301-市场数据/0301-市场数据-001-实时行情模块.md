---
file: 0301-市场数据-001-实时行情模块.md
description: 实时行情展示：多交易所数据源(Binance/CoinGecko等)、WebSocket推送、深度图
...
实时行情展示：多交易所数据源(Binance/CoinGecko等)、WebSocket推送、深度图

---

## 概述

本节描述：实时行情展示：多交易所数据源(Binance/CoinGecko等)、WebSocket推送、深度图
