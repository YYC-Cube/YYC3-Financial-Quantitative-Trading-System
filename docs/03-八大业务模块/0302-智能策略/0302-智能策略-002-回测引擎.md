---
file: 0302-智能策略-002-回测引擎.md
description: 量化策略回测系统：历史数据回放、策略性能评估、风险指标计算
...
量化策略回测系统：历史数据回放、策略性能评估、风险指标计算

---

## 概述

本节描述：量化策略回测系统：历史数据回放、策略性能评估、风险指标计算
