---
file: 0303-风险管控-002-实时风控系统.md
description: 实时监控：止损触发、仓位控制、异常检测、自动告警
...
实时监控：止损触发、仓位控制、异常检测、自动告警

---

## 概述

本节描述：实时监控：止损触发、仓位控制、异常检测、自动告警
