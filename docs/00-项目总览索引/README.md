...
| 序号 | 文档名称 | 描述 | 标签 |
|------|----------|------|------|
| 1 | [00-001-项目总览手册.md](00-001-项目总览手册.md) | 金融量化交易系统立项核心依据，八大业务模块(行情/策略/风控/量子/数据/工坊/交易/管理)，技术栈(Vite+React+TypeScript+Tailwind+pnpm) | [项目总览],[金融量化],[立项依据] |
| 2 | [00-002-文档架构导航.md](00-002-文档架构导航.md) | 文档体系导航与索引，快速定位各类文档 | [项目总览],[文档导航],[索引] |
| 3 | [00-003-快速开始指南.md](00-003-快速开始指南.md) | 项目快速启动：克隆仓库 → pnpm install → pnpm dev → 访问localhost:5173 | [项目总览],[快速开始],[本地开发] |
| 4 | [00-004-核心概念词典.md](00-004-核心概念词典.md) | 项目核心概念：AI Family 8成员、BigModel-Z.ai SDK、MCP Server、五高架构、量化交易策略 | [项目总览],[核心概念],[术语词典] |
| 5 | [00-005-版本更新日志.md](00-005-版本更新日志.md) | 项目版本迭代记录：v1.0.0八大业务模块 → v1.1.0质量体系+658测试 → v2.1.0 AI Family架构 → v2.3.0全员就绪 | [项目总览],[版本管理],[变更记录] |
