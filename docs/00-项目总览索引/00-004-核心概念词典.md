---
file: 00-004-核心概念词典.md
description: 项目核心概念：AI Family 8成员、BigModel-Z.ai SDK、MCP Server、五高架构、量化交易策略
...
项目核心概念：AI Family 8成员、BigModel-Z.ai SDK、MCP Server、五高架构、量化交易策略

---

## 概述

本节描述：项目核心概念：AI Family 8成员、BigModel-Z.ai SDK、MCP Server、五高架构、量化交易策略
