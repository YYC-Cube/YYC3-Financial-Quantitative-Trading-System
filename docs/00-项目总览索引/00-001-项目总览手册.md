---
file: 00-001-项目总览手册.md
description: 金融量化交易系统立项核心依据，八大业务模块(行情/策略/风控/量子/数据/工坊/交易/管理)，技术栈(Vite+React+TypeScript+Tailwind+pnpm)
...
金融量化交易系统立项核心依据，八大业务模块(行情/策略/风控/量子/数据/工坊/交易/管理)，技术栈(Vite+React+TypeScript+Tailwind+pnpm)

---

## 概述

本节描述：金融量化交易系统立项核心依据，八大业务模块(行情/策略/风控/量子/数据/工坊/交易/管理)，技术栈(Vite+React+TypeScript+Tailwind+pnpm)
