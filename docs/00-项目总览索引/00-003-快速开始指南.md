---
file: 00-003-快速开始指南.md
description: 项目快速启动：克隆仓库 → pnpm install → pnpm dev → 访问localhost:5173
...
项目快速启动：克隆仓库 → pnpm install → pnpm dev → 访问localhost:5173

---

## 概述

本节描述：项目快速启动：克隆仓库 → pnpm install → pnpm dev → 访问localhost:5173
