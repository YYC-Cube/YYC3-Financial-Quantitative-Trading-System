---
file: 0202-数据分析层-001-语枢·万物分析引擎.md
description: YuShuAnalysisEngine：统计指标(15+)、金融指标(Sharpe/Sortino/VaR)、MACD趋势、风险评估、报告生成(743行)
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: AI Family,数据分析,万物
category: 0202 数据分析层 001 语枢·万物分析引擎
language: zh-CN
...
YuShuAnalysisEngine：统计指标(15+)、金融指标(Sharpe/Sortino/VaR)、MACD趋势、风险评估、报告生成(743行)

---

## 概述

本节描述：YuShuAnalysisEngine：统计指标(15+)、金融指标(Sharpe/Sortino/VaR)、MACD趋势、风险评估、报告生成(743行)
...
- 标签: [AI Family],[数据分析],[万物]
- 所属模块: 02-AI-Family智能引擎 / 0202-数据分析层
