---
file: README.md
description: 02-AI-Family智能引擎 / 0202-数据分析层 目录文档索引
...
category: 02-AI-Family智能引擎 / 0202-数据分析层
project: YYC³-QATS
---
...
| 序号 | 文档名称 | 描述 | 标签 |
|------|----------|------|------|
| 1 | [0202-数据分析层-001-语枢·万物分析引擎.md](0202-数据分析层-001-语枢·万物分析引擎.md) | YuShuAnalysisEngine：统计指标(15+)、金融指标(Sharpe/Sortino/VaR)、MACD趋势、风险评估、报告生成(743行) | [AI Family],[数据分析],[万物] |
| 2 | [0202-数据分析层-002-预见·先知预测服务.md](0202-数据分析层-002-预见·先知预测服务.md) | ProphetPredictorService：Prophet+ARIMA集成预测、ZScore/MA/LevelShift异常检测、精度回测(568行) | [AI Family],[预测],[先知] |
