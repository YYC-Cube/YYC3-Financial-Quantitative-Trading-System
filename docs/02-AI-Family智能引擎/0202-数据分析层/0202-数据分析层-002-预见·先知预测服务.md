---
file: 0202-数据分析层-002-预见·先知预测服务.md
description: ProphetPredictorService：Prophet+ARIMA集成预测、ZScore/MA/LevelShift异常检测、精度回测(568行)
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: AI Family,预测,先知
category: 0202 数据分析层 002 预见·先知预测服务
language: zh-CN
...
ProphetPredictorService：Prophet+ARIMA集成预测、ZScore/MA/LevelShift异常检测、精度回测(568行)

---

## 概述

本节描述：ProphetPredictorService：Prophet+ARIMA集成预测、ZScore/MA/LevelShift异常检测、精度回测(568行)
