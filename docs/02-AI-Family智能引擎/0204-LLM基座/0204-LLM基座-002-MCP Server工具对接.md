---
file: 0204-LLM基座-002-MCP Server工具对接.md
description: YYC3-CN MCP Server：20个工具映射(代码审查/提示词优化/UI分析/协同编程等)
...
status: published
tags: AI引擎,MCP,工具集
category: 0204 LLM基座 002 MCP Server工具对接
language: zh-CN
...
YYC3-CN MCP Server：20个工具映射(代码审查/提示词优化/UI分析/协同编程等)

---

## 概述

本节描述：YYC3-CN MCP Server：20个工具映射(代码审查/提示词优化/UI分析/协同编程等)
