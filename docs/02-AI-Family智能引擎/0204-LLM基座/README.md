---
file: README.md
description: 02-AI-Family智能引擎 / 0204-LLM基座 目录文档索引
...
category: 02-AI-Family智能引擎 / 0204-LLM基座
project: YYC³-QATS
---
...
| 序号 | 文档名称 | 描述 | 标签 |
|------|----------|------|------|
| 1 | [0204-LLM基座-001-BigModel-Z.ai SDK集成.md](0204-LLM基座-001-BigModel-Z.ai SDK集成.md) | BigModelSDK：对话API(chatCompletion)、流式响应(streamChatCompletion)、Mock降级、重试机制、健康监控(359行) | [AI引擎],[BigModel],[SDK] |
| 2 | [0204-LLM基座-002-MCP Server工具对接.md](0204-LLM基座-002-MCP Server工具对接.md) | YYC3-CN MCP Server：20个工具映射(代码审查/提示词优化/UI分析/协同编程等) | [AI引擎],[MCP],[工具集] |
