---
file: 0204-LLM基座-001-BigModel-Z.ai SDK集成.md
description: BigModelSDK：对话API(chatCompletion)、流式响应(streamChatCompletion)、Mock降级、重试机制、健康监控(359行)
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: AI引擎,BigModel,SDK
category: 0204 LLM基座 001 BigModel Z.ai SDK集成
language: zh-CN
...
# 0204 LLM基座 001 BigModel Z.ai SDK集成
...
BigModelSDK：对话API(chatCompletion)、流式响应(streamChatCompletion)、Mock降级、重试机制、健康监控(359行)

---

## 概述

本节描述：BigModelSDK：对话API(chatCompletion)、流式响应(streamChatCompletion)、Mock降级、重试机制、健康监控(359行)
...
- 标签: [AI引擎],[BigModel],[SDK]
- 所属模块: 02-AI-Family智能引擎 / 0204-LLM基座
