---
file: 0203-服务支撑层-002-智云·守护安全服务.md
description: GuardianSecurityService：威胁检测(暴力破解/注入/异常IP)、速率限制、输入净化、行为基线(379行)
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: AI Family,安全,守护
category: 0203 服务支撑层 002 智云·守护安全服务
language: zh-CN
...
GuardianSecurityService：威胁检测(暴力破解/注入/异常IP)、速率限制、输入净化、行为基线(379行)

---

## 概述

本节描述：GuardianSecurityService：威胁检测(暴力破解/注入/异常IP)、速率限制、输入净化、行为基线(379行)
...
- 标签: [AI Family],[安全],[守护]
- 所属模块: 02-AI-Family智能引擎 / 0203-服务支撑层
