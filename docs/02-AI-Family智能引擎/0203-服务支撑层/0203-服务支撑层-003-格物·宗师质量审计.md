---
file: 0203-服务支撑层-003-格物·宗师质量审计.md
description: GrandmasterQualityAuditor：6维质量评分、代码问题检测、架构分析、性能评估(381行)
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: AI Family,质量,宗师
category: 0203 服务支撑层 003 格物·宗师质量审计
language: zh-CN
...
GrandmasterQualityAuditor：6维质量评分、代码问题检测、架构分析、性能评估(381行)

---

## 概述

本节描述：GrandmasterQualityAuditor：6维质量评分、代码问题检测、架构分析、性能评估(381行)
