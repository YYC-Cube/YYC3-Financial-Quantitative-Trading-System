---
file: README.md
description: 02-AI-Family智能引擎 / 0201-核心编排层 目录文档索引
...
category: 02-AI-Family智能引擎 / 0201-核心编排层
project: YYC³-QATS
---
...
| 序号 | 文档名称 | 描述 | 标签 |
|------|----------|------|------|
| 1 | [0201-核心编排层-001-元启·天枢编排器.md](0201-核心编排层-001-元启·天枢编排器.md) | TianShuOrchestrator：智能路由(8种意图)、成员注册、并行执行、降级容错、请求历史监控(424行) | [AI Family],[编排器],[天枢] |
| 2 | [0201-核心编排层-002-言启·千行NLU引擎.md](0201-核心编排层-002-言启·千行NLU引擎.md) | QianHangNLUEngine：8大意图类别、9种实体类型、情感分析、复杂度评估、对话上下文管理(561行) | [AI Family],[NLU],[千行] |
