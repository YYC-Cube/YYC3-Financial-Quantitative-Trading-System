---
file: 0201-核心编排层-002-言启·千行NLU引擎.md
description: QianHangNLUEngine：8大意图类别、9种实体类型、情感分析、复杂度评估、对话上下文管理(561行)
author: YanYuCloudCube Team
version: v2.3.1
created: 2026-05-23
updated: 2026-05-23
status: published
tags: AI Family,NLU,千行
category: 0201 核心编排层 002 言启·千行NLU引擎
language: zh-CN
...
QianHangNLUEngine：8大意图类别、9种实体类型、情感分析、复杂度评估、对话上下文管理(561行)

---

## 概述

本节描述：QianHangNLUEngine：8大意图类别、9种实体类型、情感分析、复杂度评估、对话上下文管理(561行)
